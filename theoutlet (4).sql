...
--
-- Host: 127.0.0.1
-- Generation Time: 15-Mar-2019 às 12:40
...
(44, 'td2', 'R$ 119,09', 'CSL005-1.4', '42', 45, 'Sem_estoque'),
...
(33, 'Cliente1', '123', 'Cliente1', '991', 1840552221, 1840552221, '2019-03-11', 'cliente1@gmail.com', 'maecliente', 36),
...
--
ALTER TABLE `usuario`
  MODIFY `cod_cliente` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
